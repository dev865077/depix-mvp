...
- a revisao de follow-up agora carrega os memos mais recentes dos especialistas antes da rodada do modelo, reduzindo risco de blocker drift
- a revisao de follow-up continua priorizando arquivos de teste citados e reconciliando o blocker contra o checkout quando o patch vier incompleto
