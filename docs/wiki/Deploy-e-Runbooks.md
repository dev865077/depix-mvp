...
- pedidos do canal `telegram` com `telegram_chat_id` valido agora recebem notificacao assincrona quando o agregado financeiro muda para um estado terminal relevante; duplicatas de webhook, recheck e fallback nao devem repetir a mesma mensagem
