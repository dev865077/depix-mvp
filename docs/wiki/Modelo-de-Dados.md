...
- quando um agregado financeiro confirma `depix_sent`, o sistema pode disparar a notificacao assincrona no Telegram usando `telegram_chat_id` como destino canonico
